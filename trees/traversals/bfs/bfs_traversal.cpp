...
//basic implementation of bfs-0(n)(n= number of nodes in tree)
...
void solve(){
   ...
   rep(i,0,n-1){
	...
	int root=0;	//can start from any node which is given in the question
  ...
  //instead of usign visited array, you can use parent array as well and mark the node of parent array once it is visited
